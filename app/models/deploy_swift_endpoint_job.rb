    ...
    case swift_endpoint.endpoint_type
      ...
      when "Unix"
        begin
          ...
          result = Rush.bash unix_ssh_cmd('test -e buspass-web && test -e buspass-web/script/stop_instances && bash --login -c "cd buspass-web; bundle exec script/stop_instances"')
