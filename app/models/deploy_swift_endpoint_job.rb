    ...
    case swift_endpoint.endpoint_type
      ...
      when "Unix"
        begin
          ...
          result = Rush.bash uadmin_unix_scp_cmd("sudo adduser #{user_name} --quiet --disabled-password  --group; exit 0")
          result = Rush.bash uadmin_unix_scp_cmd("sudo adduser --quiet #{user_name} busme; exit 0")
    ...
    case swift_endpoint.endpoint_type
      ...
      when "Unix"
        begin
          ...
          result = Rush.bash unix_ssh_cmd('test -e buspass-web && test -e buspass-web/script/stop_instances && bash --login -c "cd buspass-web; bundle exec script/stop_instances -e production"')
