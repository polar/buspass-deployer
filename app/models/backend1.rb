...
class Backend1
  ...
  belongs_to :frontend, :class_name => "Frontend1"
  belongs_to :installation, :class_name => "Installation1"

  many :endpoints, :dependent => :destroy, :autosave => false, :class_name => "Endpoint"

  many :swift_endpoints, :dependent => :destroy, :autosave => false, :class_name => "SwiftEndpoint1"
  many :worker_endpoints, :dependent => :destroy, :autosave => false, :class_name => "WorkerEndpoint1"
  many :server_endpoints, :dependent => :destroy, :autosave => false, :class_name => "ServerEndpoint1"
